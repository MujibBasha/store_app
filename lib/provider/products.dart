...
class Products extends ChangeNotifier {
      ...
      productSnapShot.docs.forEach((product) {
        _product.insert(
          ...
          Product(
              ...
              productCategoryName: product.get("productCategory"),
              quantity: int.parse(product.get("productQuantity")),
              isPopular: false),
        );
      });
    });
  ...
  List<Product> get popularProducts {
    return _product.where((element) => element.isPopular).toList();
  }

  Product findById(String productId) {
    return _product.firstWhere((element) => element.id == productId);
  }
